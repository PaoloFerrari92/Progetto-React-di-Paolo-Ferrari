  ...
  useEffect(() => {
   ...
   try {
       const res = await fetch(
         `https://api.nytimes.com/svc/search/v2/articlesearch.json?q=politic&api-key=${process.env.REACT_APP_ARTICLES_API_KEY}`
         )
